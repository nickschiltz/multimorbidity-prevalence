...
#Note: this has all of the code for the project 
# Need to create a "clean" final version that has only the 
# analysis used in paper. Waiting for final accepted version
# so I know what exactly to include to reproduce the manuscript.
...
#add a spline at 59 and older and 59 and under (based on MARS model)
mydata$AGE1859 <- ifelse(mydata$AGE<=58,59-mydata$AGE,0) 
...
#-------------------------------------------------------
# Plots - Figures 1 and 2 and Supp Figure 2
#------------------------------------------------------
